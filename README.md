...
- `fetch_deposits_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_margin_mode(self, symbol: str, params: dict = {})`
- `fetch_margin_modes(self, symbols: Strings = None, params: dict = {})`
...
- `fetch_open_interest(self, symbol: str, params: dict = {})`
- `fetch_open_interests(self, symbols: Strings = None, params: dict = {})`
...
- `fetch_order_trades(self, id: str, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_order(self, id: str, symbol: Str = None, params: dict = {})`
- `fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `get_withdraw_nonce(self, params: dict = {})`
- `hash_message(self, message: object)`
- `modify_margin_helper(self, symbol: str, amount: float, type: str, params: dict = {})`
- `nonce(self)`
...
- `v1_public_get_public_points_rankings(request)`
- `v1_public_get_public_points_stages(request)`
...
- `v1_public_get_tv_kline_history(request)`
...
- `v1_public_get_staking_valor2_batch_info(request)`
- `v1_public_get_staking_valor2_pool_info(request)`
- `v1_public_get_staking_valor2_revenue_buyback(request)`
...
- `v1_private_get_transfer_nonce(request)`
...
- `v1_private_get_broker_daily_fee_revenue(request)`
- `v1_private_get_orderbook_symbol(request)`
- `v1_private_get_kline(request)`
- `v1_private_get_client_margin_modes(request)`
- `v1_private_get_client_leverages(request)`
- `v1_private_get_client_points_user_statistics(request)`
- `v1_private_get_staking_valor2_redeem(request)`
- `v1_private_get_referral_multi_level_admin(request)`
- `v1_private_get_referral_multi_level_admin_info(request)`
- `v1_private_get_referral_multi_level_admin_referee_list(request)`
- `v1_private_get_referral_multi_level_admin_summary(request)`
- `v1_private_get_referral_multi_level_max_rebate_rate(request)`
- `v1_private_get_referral_multi_level_rebate_info(request)`
- `v1_private_get_referral_multi_level_referee_list(request)`
- `v1_private_get_referral_multi_level_statistics(request)`
- `v1_private_get_referral_multi_level_volume_prerequisite(request)`
...
- `v1_private_post_client_leverages(request)`
- `v1_private_post_client_margin_mode(request)`
- `v1_private_post_position_margin(request)`
...
- `v1_private_post_referral_edit_referee_description(request)`
- `v1_private_post_referral_multi_level_admin(request)`
- `v1_private_post_referral_multi_level_admin_create_affiliate(request)`
- `v1_private_post_referral_multi_level_admin_reset_affiliate(request)`
- `v1_private_post_referral_multi_level_admin_update(request)`
- `v1_private_post_referral_multi_level_admin_update_affiliate(request)`
- `v1_private_post_referral_multi_level_claim_code(request)`
- `v1_private_post_referral_multi_level_rebate_rate_set_default(request)`
- `v1_private_post_referral_multi_level_rebate_rate_update(request)`
...
- `v2_private_post_internal_transfer(request)`

### WS Unified

- `describe(self)`
- `watch_public(self, messageHash: str, message: dict)`
...
- `watch_private(self, messageHash: str, message: dict, params: dict = {})`
- `watch_private_multiple(self, messageHashes: list[str], message: dict, params: dict = {})`
...
- `load_positions_snapshot(self, client: Client, messageHash: str)`
- `watch_balance(self, params: dict = {})`
- `pong(self, client: Client, message: dict)`
