...
- `describe(self)`
- `watch_public(self, messageHash: Any, message: Any)`
...
- `watch_private(self, messageHash: Any, message: Any, params={})`
- `watch_private_multiple(self, messageHashes: Any, message: Any, params={})`
- `watch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `watch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `watch_positions(self, symbols: Strings = None, since: Int = None, limit: Int = None, params={})`
- `set_positions_cache(self, client: Client, type: Any, symbols: Strings = None)`
- `load_positions_snapshot(self, client: Client, messageHash: Any)`
- `watch_balance(self, params={})`
- `pong(self, client: Client, message: Any)`
